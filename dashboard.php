...
<head>
    ...
    <title>UPMS - User Dashboard</title>
        ...
        <div class="card-body">
            <div class="stat-widget-one">
                <div class="stat-icon dib">
                    <img src="C:\xampp\htdocs\vpms\users\includes" alt="map" style="width: 100px; height: 100px;">
                </div>
                <div class="stat-content dib">
                    <div class="stat-text">Some Text</div>
                    <div class="stat-digit">12345</div>
                </div>
            </div>
        </div>
    </div>
